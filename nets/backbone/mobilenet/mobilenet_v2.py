...
from nets.backbone.mobilenet import conv_blocks as ops
from nets.backbone.mobilenet import mobilenet as lib
...
V2_DEF = dict(
    ...
    spec=[
        ...
        op(ops.expanded_conv, stride=1, num_outputs=160),
        ## change
        op(ops.expanded_conv, stride=2, num_outputs=320),
        op(ops.expanded_conv, stride=1, num_outputs=320),
        ## add
        op(ops.expanded_conv, stride=2, num_outputs=256, expansion_size=ops.expand_input_by_factor(2)),
        op(ops.expanded_conv, stride=1, num_outputs=256, expansion_size=ops.expand_input_by_factor(2)),
        op(ops.expanded_conv, stride=2, num_outputs=256, expansion_size=ops.expand_input_by_factor(2)),
        op(ops.expanded_conv, stride=1, num_outputs=256, expansion_size=ops.expand_input_by_factor(2)),
    ],
)
